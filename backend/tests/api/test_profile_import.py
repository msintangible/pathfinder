...
def test_docx_upload_stores_the_source_document(client, tmp_path):
    """A .docx CV must be stored for reference/download, not just have its text extracted."""
...
def test_pdf_upload_stores_the_source_document(client, tmp_path):
    """A .pdf CV must be stored for reference/download, the same as docx."""
