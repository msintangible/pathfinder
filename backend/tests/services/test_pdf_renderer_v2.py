...
def test_font_substitution_is_flagged_low_confidence():
    ...
    # never PyMuPDF's own "helv"/"cour"/"tiro" shorthand, so this is the
    # expected, common-case outcome, not an edge case.
...
def test_text_that_fits_at_original_size_is_not_shrunk_or_truncated():
    text = "Short."
    layout = _pdf_layout("page[0].block[0].line[0]", text, x0=72, y0=100, x1=300, y1=114, font_size=11.0)
